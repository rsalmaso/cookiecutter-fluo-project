...
" comment out lines
nnoremap <silent> <C-C> :call NERDComment(0, "norm")<cr>
vnoremap <silent> <C-C> <ESC>:call NERDComment(1, "norm")<cr>
...
" uncomment
nnoremap <silent> <C-X> :call NERDComment(0, "uncomment")<cr>
vnoremap <silent> <C-X> :call NERDComment(1, "uncomment")<cr>
